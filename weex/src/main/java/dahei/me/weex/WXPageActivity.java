...
import dahei.me.weex.hotreload.HotReloadManager;
import dahei.me.weex.util.AppConfig;
import dahei.me.weex.util.Constants;
...
public class WXPageActivity extends AbsWeexActivity implements
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(dahei.me.weex.R.layout.activity_wxpage);
    mContainer = (ViewGroup) findViewById(dahei.me.weex.R.id.container);
    mProgressBar = (ProgressBar) findViewById(dahei.me.weex.R.id.progress);
    mTipView = (TextView) findViewById(dahei.me.weex.R.id.index_tip);
    ...
    if (!WXSoInstallMgrSdk.isCPUSupport()) {
      ...
      mTipView.setText(dahei.me.weex.R.string.cpu_not_support_tip);
      return;
    }
  ...
  public void onException(WXSDKInstance instance, String errCode, String msg) {
    ...
    if (TextUtils.equals(errCode, WXRenderErrorCode.WX_NETWORK_ERROR)) {
      mTipView.setText(dahei.me.weex.R.string.index_tip);
    } else {
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    getMenuInflater().inflate(mFromSplash ? dahei.me.weex.R.menu.main_scan : dahei.me.weex.R.menu.main, menu);
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    int id = item.getItemId();
      if(id == dahei.me.weex.R.id.action_refresh) {
        createWeexInstance();
        renderPage();
      } else if(id == dahei.me.weex.R.id.action_scan) {
        ...
        integrator.setPrompt(getString(dahei.me.weex.R.string.capture_qrcode_prompt));
